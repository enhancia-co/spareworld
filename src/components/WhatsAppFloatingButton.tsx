const WhatsAppFloatingButton = () => {
  ...
  return (
    ...
    >
      ...
      {/* Button */}
      <div className="relative w-12 h-12 sm:w-14 sm:h-14 bg-[#25D366] rounded-full shadow-lg flex items-center justify-center transition-all duration-300 hover:scale-110 hover:shadow-xl group-hover:bg-[#20BA5A]">
        <svg
      ...
      <div className="absolute right-full mr-3 top-1/2 -translate-y-1/2 opacity-0 group-hover:opacity-100 transition-opacity duration-300 pointer-events-none">
        <div className="bg-foreground text-background px-2 py-1.5 sm:px-3 sm:py-2 rounded-lg text-xs sm:text-sm font-medium whitespace-nowrap shadow-lg">
