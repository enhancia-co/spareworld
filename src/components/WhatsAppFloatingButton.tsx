const WhatsAppFloatingButton = () => {
  ...
  return (
    ...
    >
      ...
      {/* Button */}
      <div className="relative w-14 h-14 bg-[#25D366] rounded-full shadow-lg flex items-center justify-center transition-all duration-300 hover:scale-110 hover:shadow-xl group-hover:bg-[#20BA5A]">
        <svg
